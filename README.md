...
key_values = list(map(int, key_string.strip().split()))size = int(len(key_values) ** 0.5)
...
## OUTPUT
<img width="1182" height="576" alt="image" src="https://github.com/user-attachments/assets/4a92c154-8731-4512-89b6-c6900955c430" />
